        ...
        class GeminiChat {
            ...
            addMessage(content, isUser = false) {
                ...
                if (!isUser && content !== 'Solicitação enviada para contador humano. Você receberá retorno em breve via email ou telefone.') {
...
PERGUNTA: ${userMessage}`
            ...
            async sendMessage() {
                ...
                try {
                    ...
                    this.addMessage('Ocorreu um erro ao tentar obter a resposta. Por favor, tente novamente ou verifique se a API key está configurada corretamente.');
                } finally {
            ...
            contactHuman() {
                this.clearInitialContent();
                this.addMessage('Solicitação enviada para contador humano. Você receberá retorno em breve via email ou telefone.', false);
        ...
        document.addEventListener('DOMContentLoaded', () => {
            if (typeof ConteudoAcoes !== 'undefined') {
                ...
                if (chatMessagesDiv) {
                    chatMessagesDiv.innerHTML = "<p style='color:red; text-align:center; padding:20px;'>Erro crítico na inicialização do chat.</p>";
                }
            }
        });
